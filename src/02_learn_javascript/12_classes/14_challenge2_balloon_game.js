...
const balloonAttack = (playerOne, playerTwo) => {
    playerOne.balloonCount -= 10 * playerTwo.hitsPerMinute;
    playerTwo.balloonCount -= 10 * playerOne.hitsPerMinute;
...
console.log('The winner is: ' + balloonAttack(p1, p2));
