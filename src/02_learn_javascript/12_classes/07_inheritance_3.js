...
// In the example above, we create a new class named Cat that extends the Animal class. Let’s pay special attention to
// our new keywords: extends and super.
//
...
//     of the Cat class to the constructor of the Animal class. When the Animal constructor runs,
...
// We pass it 'Bryce' and false for our name and usesLitter arguments. When we call
console.log(bryceCat._name);
//our program prints, Bryce.
//
// In the example above, we abandoned best practices by calling our _name property directly. In the next exercise,
// we’ll address this by calling an inherited getter method for our name property.
