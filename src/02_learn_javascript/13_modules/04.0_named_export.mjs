...
// 1. Notice that, when we use named exports, we are not setting the properties on an object.
//    Each export is stored in its own variable.
// 2. specialty is a string object, while isVegetarian and isLowSodium are objects in the form of functions.
//    !!! Recall that in JavaScript, every function is in fact a function object!!!
// 3. export { specialty, isVegetarian }; exports objects by their variable names. Notice the keyword export is the
//    prefix.
