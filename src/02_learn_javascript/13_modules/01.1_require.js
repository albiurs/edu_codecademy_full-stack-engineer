...
//
// For instance, say we want the module to control the menu’s data and behavior, and we want a separate file to handle
// placing an order. We would create a separate file order.js and import the Menu module from menu.js to order.js using
// require(). require() takes a file path argument pointing to the original module file.
//
// In order.js we would write:

const Menu = require('./01.0_module.exports');
...
//     In order.js we import the module by creating a const variable called Menu and setting it equal to the value of
...
//     The placeOrder() function then uses the Menu module. By calling Menu.specialty, we access the property specialty
...
const Airplane = require('./01.0_module.exports');
