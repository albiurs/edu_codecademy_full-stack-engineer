...
//  - and then add an arrow => that points to the
...
// It’s important to be familiar with the multiple ways of writing functions because you will come across each of
