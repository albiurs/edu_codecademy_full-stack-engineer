...
//     - Following the try block is the catch statement which accepts the thrown error from the try block . The e
//       represents the thrown error.
//     - The curly braces that follow catch(e) is known as the catch block and contains code that executes to handle the
//       error.
//     - Since the error is caught, our console.log() after the try...catch statement prints 'The thrown error that was
...
try {
    throw Error('This is a custom thrown error!');
} catch (e) {
    console.log(e);
}
