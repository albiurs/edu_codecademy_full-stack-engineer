// Writable Streams
//
// In the previous exercise, we were reading data from a stream, but we can also write to streams! We can create a
// writeable stream to a file using the fs.createWriteStream() method:
