// Filesystem
//
// All of the data on a computer is organized and accessed through a filesystem. When running JavaScript code on a
// browser, it’s important for a script to have only limited access to a user’s filesystem. This technique of isolating
...
// available on the "fs" core module is the ".readFile()" method which reads data from a provided file:
...
//      3. The third argument is the callback function to be invoked when the asynchronous task of reading from the file
//         system is complete. Node will pass the contents of file.txt into the provided callback as its second argument.
