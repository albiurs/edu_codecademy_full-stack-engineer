...
// What if we wanted to rename this function without sacrificing the source code? We can re-assign the function to a
// variable with a suitably short name:

const busy = announceThatIAmDoingImportantWork; // no parentheses () for re-assignment

busy(); // This function call barely takes any space!

// busy is a variable that holds a _reference_(!!!) to our original function. If we could look up the address in
// memory of busy and the address in memory of announceThatIAmDoingImportantWork they would point to the same place.
// Our new busy() function can be invoked with parentheses as if that was the name we originally gave our function.
//
// Notice how we assign announceThatIAmDoingImportantWork without parentheses as the value to the busy variable. We
...
//     as .toString(). You can see more about the methods and properties of functions in the documentation:
