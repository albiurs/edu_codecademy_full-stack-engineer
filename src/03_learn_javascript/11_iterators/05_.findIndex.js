...
console.log(lessThanTen); // Output: 3 (= index in array)
...
const foundAnimal = animals.findIndex(el => el === 'elephant'); // returns 7
console.log(foundAnimal);

const startsWithS = animals.findIndex(el => el[0] === 's'); // returns 3
