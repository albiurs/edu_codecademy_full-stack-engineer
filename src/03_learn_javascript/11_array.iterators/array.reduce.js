...
// stores the returned value of 
const summedNums0 = numbers0.reduce((accumulator, currentValue) => {
    console.log(`accumulator = ${accumulator} - currentValue = ${currentValue}`);
    return accumulator + currentValue;
});

console.log(summedNums0); // Output: 17
...
//
// The .reduce() method can also take an optional second parameter to set an initial value for accumulator (remember,
